    ...
    <section className="w-full py-20">
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center w-full gap-4">
        ...
        <Card
          ...
          des="This phase focuses on turning ideas into reality. From setting up the backend architecture to designing responsive user interfaces, I work iteratively, integrating feedback to ensure the product meets expectations and is scalable. Regular progress updates ensure transparency and alignment."
        >
          <CanvasRevealEffect
            animationSpeed={3}
